...
import { useUserTweetsInfinite } from '@/lib/queries/users';
...
interface UserTweetsTimelineProps {
  userId: string;
  isMyProfile: boolean;
  username: string;
}

export function UserTweetsTimeline({ userId, isMyProfile, username }: UserTweetsTimelineProps) {
